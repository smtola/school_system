...
@section('content')
<form action="{{ route('attendances.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
    @csrf
    ...
    <div class="mb-4">
        ...
        <input type="date" name="date" class="bg-gray-200 text-gray-800 w-full p-2 border border-gray-300 rounded-md">
    </div>
